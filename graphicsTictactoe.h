# ifndef _GRAPHICSTICTACTOE__H
# define _GRAPHICSTICTACTOE__H
...
struct Graphics {
    ...
    SDL_Window *window;
    SDL_Texture *cellEmpty, *cellX, *cellO, *player1Win, *player2Win;
    ...
    void init(){
        ...
        player1Win = loadTexture("player1_win.png");
        player2Win = loadTexture("player2_win.png");
    ...
    void render(const Tictactoe& game) {
       for (int i = 0; i < BOARD_SIZE; i++){
        ...
        switch (game.winner){
            case X_CELL:
                renderTexture(player1Win, 500, 10);
                break;
            case O_CELL:
                renderTexture(player2Win, 500, 10);
                break;
        };
    ...
    void quit()
    {
        ...
        cellO = nullptr;
        SDL_DestroyTexture(player1Win);
        player1Win = nullptr;
        SDL_DestroyTexture(player2Win);
        player2Win = nullptr;
